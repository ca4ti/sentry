...
class AuthHandler:
    def __init__(self, auth_provider, provider, organization, request) -> "AuthHandler":
...
class AuthHelper:
    ...
    def auth_handler(self):
        return AuthHandler(self.auth_provider, self.provider, self.organization, self.request)
